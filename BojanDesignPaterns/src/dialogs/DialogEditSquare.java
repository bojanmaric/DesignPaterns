...
public class DialogEditSquare extends JDialog {
	...
	public DialogEditSquare(Square s)
	{
		...
		JLabel lblEditSquare = new JLabel("Edit Square");
		GridBagConstraints gbc_lblEditSquare = new GridBagConstraints();
		gbc_lblEditSquare.insets = new Insets(0, 0, 5, 0);
		gbc_lblEditSquare.gridx = 1;
		gbc_lblEditSquare.gridy = 0;
		jpMainPanel.add(lblEditSquare, gbc_lblEditSquare);
		...
		btnAccept.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					if (startX < 1 || startX > 750 || startY < 1 || startY > 520 || side < 1 || side > 400) {
					...
					JOptionPane.showMessageDialog(DialogEditSquare.this,
							"Only numbers 1-750 for X, 1-520 for Y and 1-400 for side allowed", "Warrning",
