...
public class DialogEditLine extends JDialog {
	...
	public DialogEditLine(Line l) {
		...
		jpMainPanel.setLayout(gbl_jpMainPanel);
						...
						GridBagConstraints gbc_lblEditLine = new GridBagConstraints();
						gbc_lblEditLine.insets = new Insets(0, 0, 5, 0);
						gbc_lblEditLine.gridx = 1;
						gbc_lblEditLine.gridy = 0;
						jpMainPanel.add(lblEditLine, gbc_lblEditLine);
		...
		btnAccept.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					...
					if (startX < 1 || startX > 750 || startY < 1 || startY > 520 || endX < 1 || endX > 750 || endY < 1
							|| endY > 520) {
						throw new NumberFormatException();
					}
					dispose();
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(DialogEditLine.this, "Only numbers 1-750 for X and 1-520 for Y allowed",
