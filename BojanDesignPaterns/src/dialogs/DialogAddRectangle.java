...
public class DialogAddRectangle extends JDialog {
	...
	public DialogAddRectangle() {
		...
		JLabel lblSetWidthAnd = new JLabel("Set width and heigth fo Rectagnle");
		GridBagConstraints gbc_lblSetWidthAnd = new GridBagConstraints();
		gbc_lblSetWidthAnd.insets = new Insets(0, 0, 5, 0);
		gbc_lblSetWidthAnd.gridx = 1;
		gbc_lblSetWidthAnd.gridy = 0;
		mainPanel.add(lblSetWidthAnd, gbc_lblSetWidthAnd);
		...
		btnAccept.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				try {
					...
					if(rectangleWidth>500 || rectangleWidth<1 || rectangleHeight>500 || rectangleHeight<1)
					{
